...
- (void)setupUserTable{
    ...
    [self storeString:@"test" WithKey:@"userName"];
    [self storeString:@"test123" WithKey:@"userPwd"];
...
- (void)setupGameOrdersTable{
    ...
    [a1 addObjectsFromArray:@[@"aa0708000700000010ff",
                      @"aa0700000000000100ff",
                      @"aa0709000850000100ff",
                      @"aa0701000100000100ff",
                      @"aa0706000100000100ff",
                      @"aa0702000200000010ff",
                      @"aa0701000300000100ff",
                      @"aa0707000350000100ff",
                      @"aa0703000500000010ff",
                      @"aa0700000500000100ff",
                      @"aa0704000600000100ff",
                      @"aa0705000600000100ff",
                      @"aa0708000700000001ff"] ];
    [self storeObject:a1 WithKey:@"1"];
    NSMutableArray *a2 = [NSMutableArray array];
    [a2 addObjectsFromArray:@[@"aa0700000000000400ff",
    ...
    [a4 addObjectsFromArray:@[@"aa0700000000000400ff",
                                         @"aa0701000100000400ff",
                                         @"aa0702000200000400ff",
                                         @"aa0703000300000400ff",
                                         @"aa0704000400000400ff",
